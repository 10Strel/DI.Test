using DI.Test.Web.Controllers.Common;
...
namespace DI.Test.Web.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IUserRepository<UserViewModel> repository)
        {
            _users = repository;
        }
        ...
        {
            bool resVerified = CommonMethods.IntPositiveTryParse(id, out int idParamVerified);
            if (!resVerified)
            {
